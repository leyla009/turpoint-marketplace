...
export default function PlannerPage() {
  ...
  return (
    <div className="min-h-full px-4 sm:px-6 pt-6 pb-16 max-w-3xl mx-auto">
            ...
            <div className="space-y-3">
              {result.selected_tours.map((tour, i) => (
                <button
                  ...
                  className="w-full text-left flex items-center justify-between gap-3 bg-card border border-border rounded-xl p-4 hover:border-primary/30 transition-all"
                >
